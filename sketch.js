...
//Creacion de objetos 
     ...
     obstaculo1Imagen = loadImage("./obstacle1.png");
     obstaculo2Imagen = loadImage("./obstacle2.png");
     obstaculo3Imagen = loadImage("./obstacle3.png");
     obstaculo4Imagen = loadImage("./obstacle4.png");
     obstaculo5Imagen = loadImage("./obstacle5.png");
     obstaculo6Imagen = loadImage("./obstacle6.png");
     ...
     musicaDeFondo = loadSound("./CoroCoral.mp3");
}
